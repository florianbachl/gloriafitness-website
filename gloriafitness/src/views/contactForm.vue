          ...
          <div>
            ...
            <div id="consent-group">
              <input
                ...
                id="consent" /><label for="mce-CONSENT-0" id="consentlabel"
                >Ich habe die Datenschutz-Bedingungen gelesen und bin mit der
                Datenverarbeitung einverstanden.</label
              >
            </div>
            ...
            <button type="submit" value="send" name="send" class="pb">
              Absenden
            </button>
          </div>
        </form>
  ...
  export default {
    ...
    methods: {
      ...
      checkForm: function (e) {
        ...
        if (!this.consent) {
          this.errors.push(
            "Datenschutz-Bestimmungen müssen akzeptiert werden."
          );
